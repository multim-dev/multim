...
object NotesHybridTimelineResponseSerializer : KSerializer<NotesHybridTimelineResponse> {
    ...
    override val descriptor: SerialDescriptor = NotesHybridTimelineResponseDescriptor


    override fun deserialize(decoder: Decoder): NotesHybridTimelineResponse {
        return NotesHybridTimelineResponse(ListSerializer(Note.serializer()).deserialize(decoder))
    }
